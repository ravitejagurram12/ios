...
var d1 = 25
var d2 = 26.8
var area1 = (Double(d1) * d2)/2
print("The area of the rhombus with given diagonal values is \(area1)")
    print("----------------------")
// End of question 3
...
print("My name is Raviteja Gurram ", terminator:"")
print("I am from INDIA ")
print("I am here to do my masters in ACS ")
print("----------------------")
// End of question 4
